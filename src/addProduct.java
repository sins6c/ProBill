...
public class addProduct extends JPanel {
	...
	public addProduct() {
		...
		btnAddProduct.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (quanField.getText().equals("") || idField.getText().equals("")) {
					...
					DB.addProductToDB(id, detail, comp, quan, price, minLimit);
					idField.setText("");
					quanField.setText("");
					priceField.setText("");
		...
		btnAddProduct.setBounds(449, 400, 136, 23);
		add(btnAddProduct);

		quanField = new JTextField();
		quanField.setColumns(10);
		quanField.setBounds(449, 305, 136, 20);
		add(quanField);

		JLabel lblQuantity = new JLabel("Items available");
		lblQuantity.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblQuantity.setBounds(246, 304, 124, 21);
		add(lblQuantity);
